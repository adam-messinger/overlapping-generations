...
- **Regional financing spreads**: per-region WACC = global rate + spread (IEA Cost of Capital Observatory); EMDE regions face costlier capital, `financingSpreadScale` dials friction (0 = frictionless)
