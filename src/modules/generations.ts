...
> = defineModule<GenerationsParams, GenerationsState, GenerationsInputs, GenerationsOutputs>({
  ...
  connectorTypes: {
    ...
    outputs: {
      ...
      aggregateCapitalFundingGap: unitPort('$T/year'),
      aggregateCapitalCoverage: unitPort('fraction'),
      cohortBorrowingLimitGap: unitPort('$T/year'),
      cohortCreditRationingGap: unitPort('$T/year'),
      constrainedWorkingShare: unitPort('fraction'),
      borrowingConstrainedWorkingShare: unitPort('fraction'),
      cohortBequests: unitPort('$T/year'),
      cohortAssets: unitPort('$T'),
      cohortLiabilities: unitPort('$T'),
    },
  },
