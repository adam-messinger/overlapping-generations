 ...
 *
 * standardCollectors is the canonical source of truth for output field names,
 * metadata, and extraction logic. describeOutputs() in introspection.ts
 * auto-generates from this.
 *
 * Usage:
...
import { Region, REGIONS } from './types.js';
