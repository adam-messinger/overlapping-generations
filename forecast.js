 ...
 *   node forecast.js --scenario=plateau   # Alternative scenario
 */
...
function parseArgs() {
    const args = {
        ...
        solarGrowth: 0.25,
        climSensitivity: 3.0,
        scenario: 'central'  // central, plateau, breakthrough
    };
...
function generateForecast(params) {
    const simParams = {
        ...
        solarGrowth: params.solarGrowth,
    ...
    const narratives = generateNarratives(data, metrics, params);
    ...
    const scenarioName = scenarioNames[params.scenario] || scenarioNames.central;

    // Output
    console.log(`# Twin-Engine Century Forecast — ${scenarioName}\n`);
    ...
    console.log(`\n*Generated by energy-sim.js | Carbon price: $${params.carbonPrice}/ton | Climate sensitivity: ${params.climSensitivity}°C*`);
}

// Run
const args = parseArgs();
generateForecast(args);
